...
public class InspectPlayerCreationChain extends BN_JKScript {
    ...
    T[] targets = {
        new T("PlayerPedAllocator", 0x10023cb7cL),
        new T("PlayerFactoryCaller", 0x1000dd1b4L),
    ...
    public void run() throws Exception {
        ...
        PrintWriter out = new PrintWriter(
            "/root/BN_JK-analysis/output/player_creation_chain.txt"
        );
        ...
        for (T t : targets) {
            ...
            DecompileResults r =
                d.decompileFunction(f, 180, monitor);
        ...
        out.close();
        println("PLAYER_CREATION_CHAIN_COMPLETE");
    }
}
